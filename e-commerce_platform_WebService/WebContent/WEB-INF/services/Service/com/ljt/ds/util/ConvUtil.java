...
//    /**
//     * DTOから、Mapに値をセットする。<BR>
//     * @param dtoData DTOデータ
//     * @return Mapデータ
//     * @author hiSoft GaoHang 2012/02/20
//     */
//    public static Map<String, Object> convDtoToMap(Object dtoData) {
//        Map<String, Object> mpData = new HashMap<String, Object>();
//
//        Field[] flds = dtoData.getClass().getDeclaredFields();
//
//        for (Field fd : flds) {
//            try {
//                mpData.put(fd.getName().toUpperCase(), PropertyUtils.findProperty(dtoData, fd.getName()));
